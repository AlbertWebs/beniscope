...
--
-- Host: localhost
-- Generation Time: May 27, 2025 at 08:20 AM
...
INSERT INTO `category` (`id`, `title`, `image`, `description`, `col`, `slung`, `created_at`, `updated_at`) VALUES
(1, 'Steel', NULL, NULL, '0', 'steel', NULL, NULL),
(2, 'Cement', NULL, NULL, '0', 'cement', NULL, NULL),
(3, 'Concrete', NULL, NULL, '0', 'concrete', NULL, NULL),
(4, 'Binding Wire', NULL, NULL, '0', 'binding-wire', NULL, NULL),
(5, 'Wood', NULL, NULL, '0', 'wood', NULL, NULL),
(6, 'Stone', NULL, NULL, '0', 'stone', NULL, NULL),
(7, 'Bricks', NULL, NULL, '0', 'bricks', NULL, NULL);
...
CREATE TABLE `construction_materials` (
  ...
  `construction_category_id` bigint UNSIGNED DEFAULT NULL,
  `construction_subcategory_id` bigint UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `construction_subcategories`
--
...
CREATE TABLE `construction_subcategories` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slung` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `construction_category_id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(5, '2025_03_20_141828_create_construction_materials_table', 5),
(6, '2025_03_20_141837_create_construction_categories_table', 6),
(7, '2025_03_21_092830_create_construction_subcategories_table', 7);
...
(3, NULL, 'Admin', NULL, 'admin@beniscope.com', '$2y$12$1nJOF6CzkE1As7M3ZUAgSu/IsDdW9wKQeZa4jBZN07qw26DvRE5Mi', 'joUseuA2tzmGZg5a3Pit3tuNLXCel3GP7LgLpZXNMOuaTS0WoCEQwDh2RaI1', '2025-05-26 09:18:44', '2025-05-26 09:18:44');
...
ALTER TABLE `construction_categories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `construction_categories_title_unique` (`title`),
  ADD UNIQUE KEY `construction_categories_slung_unique` (`slung`);
...
ALTER TABLE `construction_materials`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `construction_materials_slug_unique` (`slug`);

--
-- Indexes for table `construction_subcategories`
--
ALTER TABLE `construction_subcategories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `construction_subcategories_construction_category_id_foreign` (`construction_category_id`);
...
--
-- AUTO_INCREMENT for table `construction_subcategories`
--
ALTER TABLE `construction_subcategories`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `construction_subcategories`
--
ALTER TABLE `construction_subcategories`
  ADD CONSTRAINT `construction_subcategories_construction_category_id_foreign` FOREIGN KEY (`construction_category_id`) REFERENCES `construction_categories` (`id`) ON DELETE CASCADE;
COMMIT;
